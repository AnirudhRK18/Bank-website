        ...
        <div className={layout.sectionImgReverse}>
          ...
          <div className={layout.sectionInfo}>
            ...
            <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque voluptate tempore tempora autem expedita, libero adipisci hic, tenetur error consequuntur, dolorum quasi ex assumenda.
            </p>
